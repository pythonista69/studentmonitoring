# Project aSES<sup>TM</sup>: AI Bases Student Monitoring System 
![ases-banner](https://user-images.githubusercontent.com/77436548/193458047-a42b20fd-16f5-45e3-8d0c-4aa80e502cd8.gif)

## 🗺️ Background
> *"The Smart Nation is an initiative by the Government of India to harness Infocomm technologies, networks and big data to create tech-enabled solutions."* 
...
Key in relevant info via `Welcome to AI Based Student Monitoring System` page, the system can be run on the students devices via USB/webcame/Raspberry Pi camera and track their engagements during online classes.
